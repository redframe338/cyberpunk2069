...
// Neon map pass: brighter urban networks without adding new light sources.
static const float CITY_LIGHTS_INTENSITY 		= 6.25;
static const float CITY_LIGHTS_BLOOM_FACTOR 	= 0.36;
...
static const float3 SNOW_COLOR 					= float3( 0.38, 0.50, 0.66 );
...
static const float3 FOG_COLOR 					= float3( 0.008, 0.006, 0.028 );
static const float 	FOG_BEGIN					= 1.0f;
static const float 	FOG_END 					= 150.0f;
static const float 	FOG_MAX 					= 0.30f; 
